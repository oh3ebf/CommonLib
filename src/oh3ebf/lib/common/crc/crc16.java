...
public class crc16 extends crcBase {

    /* table for CRC_POLYNOM 0x8408 */
    ...
    /**
     * Creates a new instance of crc16
     *
     */
    public crc16() {
    }
     ...
     *
     * @return a byte-array of length 2 containing the checksum
     *
     */
    /* TODO: muuta siten että paluu arvo voi olla int
     ...
     resp[0] = (byte)(crc & 0xFF);
     resp[1] = (byte)((crc >> 8) & 0xFF);
